...
class Unet(EncoderDecoder):
    def __init__(self, target_channel_num, input_channel_num, encoder_name):
        ...
        super().__init__(target_channel_num, input_channel_num, encoder_name)
...
class ClassicUnet(Unet):
    def __init__(self, target_channel_num, input_channel_num=3):
        super().__init__(target_channel_num, input_channel_num, encoder_name='classic_unet')
...
class Vgg11bn(Unet):
    def __init__(self, target_channel_num, input_channel_num=3):
        super().__init__(target_channel_num, input_channel_num, encoder_name='vgg11_bn')
...
class Vgg16bn(Unet):
    def __init__(self, target_channel_num, input_channel_num=3):
        super().__init__(target_channel_num, input_channel_num, encoder_name='vgg16_bn')
...
class Vgg11(Unet):
    def __init__(self, target_channel_num, input_channel_num=3):
        super().__init__(target_channel_num, input_channel_num, encoder_name='vgg11')
...
class Resnet34_transconv(Resnet):
    def __init__(self, target_channel_num, input_channel_num=3):
        ...
        super().__init__(target_channel_num, input_channel_num, encoder_name='resnet34')
...
class Resnet34_embeddings(Resnet):
     ...
     def make_final_classifier(self, in_filters, target_channel_num):
...
class Resnet18(Resnet):
    def __init__(self, target_channel_num, input_channel_num=3):
        super().__init__(target_channel_num, input_channel_num, encoder_name='resnet18')
...
class Resnet34SpatialDropout(Resnet):
    ...
    def make_final_classifier(self, in_filters, target_channel_num):
        return nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Dropout2d(p=0.3),
            nn.Conv2d(in_filters // 2, target_channel_num, 3, padding=1),
        )
...
class Resnet50(Resnet):
    def __init__(self, target_channel_num, input_channel_num=3):
        self.decoder_type = Upscale.upsample_bilinear
        super().__init__(target_channel_num, input_channel_num, encoder_name='resnet50')
...
class Incv3(EncoderDecoder):
    def __init__(self, target_channel_num, input_channel_num=3):
        super().__init__(target_channel_num, input_channel_num, encoder_name='inceptionv3')
...
class LinkNetIncvRes2(EncoderDecoder):
    def __init__(self, target_channel_num, input_channel_num=3):
        super().__init__(target_channel_num, input_channel_num, encoder_name='inception_resnet_v2')
...
class DPNUnet(DPEncoderDecoder):
    def __init__(self, target_channel_num, input_channel_num=3, encoder_name='dpn92'):
        # self.decoder_block = UnetDoubleDecoderBlock
        self.bottleneck_type = ConvBottleneck
        super().__init__(target_channel_num, input_channel_num, encoder_name)
